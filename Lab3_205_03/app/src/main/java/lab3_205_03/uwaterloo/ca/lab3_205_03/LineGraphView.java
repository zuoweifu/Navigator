...
public class LineGraphView extends View
{
     ...
     * @param dataWidth How many data points to display before the compass starts scrolling
    ...
    /**
     * Sets the colors for the y-values of the compass. Order should match the order of the labels.
     *
    ...
    /**
     * Clears all the data from the compass.
     */
    public void purge(){
        points.clear();
        invalidate();
